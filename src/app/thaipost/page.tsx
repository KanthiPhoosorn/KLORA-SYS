      ...
      <div className="no-print space-y-8">
        <div>
          <h1 className="flex items-center gap-2 text-2xl font-bold text-emerald-950">
            <Package className="text-emerald-600" /> ปลายน้ำ · Thai Post
          </h1>
        ...
        <form
          onSubmit={onSearch}
          className="flex gap-2 rounded-2xl border border-emerald-900/10 bg-white/80 p-2 shadow-sm"
        >
        ...
        {supplier ? (
          <div className="space-y-4">
            <div className="rounded-xl border border-emerald-900/10 bg-white/70 px-5 py-3">
                  ...
                  .map((b) => (
                    <div key={b.id} className="space-y-3">
                      ...
                      <div className="text-center">
                        <button
                          onClick={() => print(b)}
                          className="inline-flex items-center gap-2 rounded-xl border border-emerald-900/15 bg-white px-4 py-2 text-sm font-medium text-emerald-800 hover:bg-emerald-50"
                        >

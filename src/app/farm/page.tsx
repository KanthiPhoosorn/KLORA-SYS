    ...
    <div className="space-y-8">
      <div>
        <h1 className="flex items-center gap-2 text-2xl font-bold text-emerald-950">
          <Sprout className="text-emerald-600" /> ต้นน้ำ · ฟาร์ม
        </h1>
      ...
      <div className="grid gap-6 lg:grid-cols-5">
        ...
        <div className="space-y-3 lg:col-span-2">
          ...
          {suppliers.length === 0 ? (
            <p className="rounded-xl border border-dashed border-emerald-900/15 px-4 py-8 text-center text-sm text-emerald-900/50">

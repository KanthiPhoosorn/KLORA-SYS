    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-[760px] px-6 py-12 text-[15px]">
        ...
        <P>
          ...
          คุณลบบัญชีได้เองทันทีจากหน้าโปรไฟล์ — ข้อมูลเข้าสู่ระบบ อีเมล เบอร์โทร และการเป็นสมาชิกทีมจะถูกลบ ส่วนประวัติรอบส่งออกและผลคำนวณคาร์บอนจะเก็บไว้แบบไม่ระบุตัวบุคคลเพื่อการตรวจสอบย้อนหลัง
        </P>
